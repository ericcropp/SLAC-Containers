...
RUN conda create -n simulation -y && \
    conda install -n simulation -y lume-impact impact-t=2.3.1=mpi_openmpi* jupyter jupyterlab scipy numpy matplotlib pillow pandas xopt distgen h5py openpmd-beamphysics pytao pmd_beamphysics pyyaml pickle
